...
totalVenue = matches['city'].nunique()
...
isTossAlsoMatch = px.pie(
    ...
    values=slices,
    names=['Yes', 'No'],
    title='Is Toss Winner also the Match Winner?'
)
...
score1stInning = px.box(
    ...
    y='total_runs',
    color='batting_team',
    title='Score Distribution for Team in their 1st Innings',
    labels={
        'batting_team': 'Teams',
        'total_runs': 'Runs'
    },
...
score2ndInning = px.box(
    ...
    y='total_runs',
    color='batting_team',
    title='Score Distribution for Team in their 2nd Innings',
    labels={
        'batting_team': 'Teams',
        'total_runs': 'Runs'
    },
...
app.layout = html.Div([
    ...
    # Basic Data Analysis
    html.Div([
        html.P('Total venues played at: {}'.format(totalVenue)),
        html.P('Total Matches Played: {}'.format(totalMatchesPlayed)),
        html.P('Total Umpires: {}'.format(totalUmpires)),
        html.P('High Number of Match Wins: {0}({1} wins)'.format(
    ...
    ], id='performance', style={'columnCount': '2'})
